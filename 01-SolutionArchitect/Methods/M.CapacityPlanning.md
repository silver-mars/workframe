...
virtual machines lose nanoseconds for save their current context and switch to an another process, but human lose more time, AI agents also need more memory to free up current quests and load a new task, so this is 
