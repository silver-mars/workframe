...
Step by step
1. Define the system's criticality class. Of there is another reason to prioritize it, clarify that as well, for example a high-priority feature release requested by CTO or an
