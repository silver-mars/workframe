...
In Kubernetes-based systems one practical implementation of that viewpoint is the use of securityContext settings at Pod and Container scope, because Kubernetes defines security context settings 
