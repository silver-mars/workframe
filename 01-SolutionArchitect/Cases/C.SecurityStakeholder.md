...
For Kubernetes-based workloads, this security viewpoint can be expressed throught Pod and Container scope, because Kubernetes defines security context settings at both PodSpec and ContainerSpec levels, and container-level values takes precedence when the same setting is configured in both scopes.
