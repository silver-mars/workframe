...
For Kubernetes-based workloads, ne practical implementation of that viewpoint is the use of securityContext settings at Pod and Container scope, because Kubernetes defines security context settings at both PodSpec and ContainerSpec levels, and container-level values takes precedence when the same setting is configured in both scopes.
